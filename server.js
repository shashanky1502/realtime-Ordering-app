...
app.use(
  session({
    //use the session middleware to create a session for the user and store the user data in the session object in the req object (req.session) and the session object is available in the ejs file as req.session (req.session.user)
